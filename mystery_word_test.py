...
def test_result(self):
    self.assertTrue(display_word('hola', ['h', 'o', 'l',
                                    'a', 'r']) == 'h o l a '
def test_incorrect_answers(self):
    self.assertTrue(display_word('hola', ['q', 'w', 'r']) == '_ _ _ _ '

def test_good_letter_guess(self):
    self.assertFalse(incorrect_guess(3, 'r', 'hola') == 2

def only_letters(self):
    self.assertFalse(incorrect_guess(4, '%', 'hola'), )
